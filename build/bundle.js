...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _marionette = __webpack_require__(8);
	...
	var router = exports.router = (0, _marionette.createRouter)({
	  log: true,
	  logError: true
	});
	
	router.map(function (route) {
	  route('index', { path: '/', routeClass: _app2.default }, function () {
	    route('browse', { routeClass: _list2.default, abstract: true }, function () {
	      route('browse.default', { path: '', viewClass: _view2.default });
	    });
	    route('detail', { path: '/product/:productid', routeClass: _detail2.default });
	    route('review', { path: '/review', routeClass: _review2.default });
	  });
	});
	...
	router.use(_marionette.middleware);
	
	_backbone4.default.channel('router').on('before:transition', function (transition) {
	  if (transition.path === '/') {
	    transition.redirectTo('browse.default');
	  }
	});
	
	_backbone4.default.channel('transit').on('go:order', function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	(function (global, factory) {
		 true ? module.exports = factory(__webpack_require__(2), __webpack_require__(3), __webpack_require__(7)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? module.exports = factory(__webpack_require__(3), __webpack_require__(2)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ = _interopDefault(__webpack_require__(3));
	var Radio = _interopDefault(__webpack_require__(7));
	var Marionette = _interopDefault(__webpack_require__(6));
	var cherrytree = _interopDefault(__webpack_require__(9));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dash = __webpack_require__(11);
	
	var _dsl = __webpack_require__(12);
	...
	var _locationsBrowser = __webpack_require__(17);
	
	var _locationsBrowser2 = _interopRequireDefault(_locationsBrowser);
	
	var _locationsMemory = __webpack_require__(20);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _locationBar = __webpack_require__(18);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mockApi = __webpack_require__(27);
	...
	exports.default = _marionette.Route.extend({
	  activate: function activate() {
	    ...
	    this.api = new _mockApi.MockAPI();
	    this.newOrderInfo = new _order2.default();
	    return this.api.getProductList().then(function (list) {
	      _this.products = new _products2.default(list);
	    });
	  },
...
/***/ (function(module, exports) {
	...
	var MockAPI = exports.MockAPI = function () {
	  function MockAPI() {
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var Order = _backbone2.default.Model.extend({
	  defaults: {
	    product: 1,
	    size: 'S',
	    color: 'R',
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var Products = _backbone2.default.Collection.extend({
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var Product = _backbone2.default.Model.extend({
	  defaults: {
	    name: '',
	    image: ''
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _databinding = __webpack_require__(33);
	 ...
	 */
	var ProductItemView = _backbone2.default.View.extend({
	  behaviors: [_databinding2.default],
	  tagName: 'li',
	 ...
	 * View Component for Product Item page
	 */
	var BrowseListView = _backbone2.default.CollectionView.extend({
	  tagName: 'ul',
	  className: 'list-group',
	  childView: ProductItemView,
	  behaviors: [_marionette.RouterLink]
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rivets = __webpack_require__(34);
	...
	exports.default = _backbone2.default.Behavior.extend({
	  ...
	  onBeforeRender: function onBeforeRender() {
	    ...
	    this._rview = _rivets2.default.bind(this.el, view, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  if (typeof (typeof module !== "undefined" && module !== null ? module.exports : void 0) === 'object') {
	    module.exports = Rivets.factory(__webpack_require__(35));
	  } else if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(35)], __WEBPACK_AMD_DEFINE_RESULT__ = function(sightglass) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	    ...
	    if (true) {
	        // CommonJS
	        factory(__webpack_require__(34), __webpack_require__(2));
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"row\">\n    <div class=\"col-md-8 contact-list browse\">\n      <p>\n        <span class=\"list-group-item-text\">Hello World!!</span>\n      </p>\n    </div>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = _marionette.Route.extend({
	  ...
	  activate: function activate(transition) {
	    var products = this.getContext().request('products');
	   ...
	   */
	  onSaveModel: function onSaveModel(view) {
	    var attributes = _underscore2.default.clone(view.model.attributes);
	    ...
	    var savePromise = _backbone2.default.channel('api').request('saveOrder', attributes);
	
	    savePromise.then(function (saveData) {
	      _backbone2.default.channel('transit').trigger('go:order', 'abcdefghijklmnopqrstuvxyz');
	    });
	  }
	});
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"panel panel-primary\">\n    <div class=\"panel-heading\">\n        <h3 class=\"panel-title\">{model:name}</h3>\n    </div>\n    <div class=\"panel-body\">\n        <form role=\"form\" class=\"form-horizontal\">\n            <div class=\"form-group\">\n                <img rv-src=\"model:image_path\" rv-alt=\"model:name\" height=\"150\" width=\"150\" />\n            </div>\n\n            <div class=\"form-group\">\n                <label class=\"col-sm-2 control-label\">Size: </label>\n                <div class=\"col-sm-10 size\">\n                  <input type=\"radio\" name=\"size\" value=\"S\" checked id=\"sizeSmall\"><label for=\"sizeSmall\">Small</label>\n                  <input type=\"radio\" name=\"size\" value=\"M\" id=\"sizeMedium\"><label for=\"sizeMedium\">Medium</label>\n                  <input type=\"radio\" name=\"size\" value=\"L\" id=\"sizeLarge\"><label for=\"sizeLarge\">Large</label>\n                </div>\n            </div>\n\n            <div class=\"form-group\">\n              <label class=\"col-sm-2 control-label\">Color: </label>\n              <div class=\"col-sm-10 color\">\n                <input type=\"radio\" name=\"color\" value=\"Red\" checked id=\"colorRed\"><label for=\"colorRed\">Red</label>\n                <input type=\"radio\" name=\"color\" value=\"Green\" id=\"colorGreen\"><label for=\"colorGreen\">Green</label>\n                <input type=\"radio\" name=\"color\" value=\"Blue\" id=\"colorBlue\"><label for=\"colorBlue\">Blue</label>\n              </div>\n            </div>\n\n            <div class=\"form-group\">\n                <label class=\"col-sm-2 control-label\">Quantity: </label>\n                <div class=\"col-sm-10\">\n                  <input type=\"number\" min=\"1\" max=\"5\" step=\"1\" rv-value=\"model:quantity\">\n                </div>\n            </div>\n        </form>\n    </div>\n</div>\n\n<div class=\"button-bar\">\n    <button id=\"save-contact\" class=\"btn btn-success\">continue shopping</button>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = _marionette.Route.extend({
	  ...
	  activate: function activate() {
	    ...
	    var getPromise = _backbone2.default.channel('api').request('getOrder');
	    return getPromise.then(function (orderData) {
	      _this.reviewOrder = new _order2.default(orderData);
	    });
	  },
	  viewOptions: function viewOptions() {
	    return {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ShippingAddressView = _backbone2.default.View.extend({
	  behaviors: [_databinding2.default],
	  tagName: 'div',
	...
	exports.default = _backbone2.default.View.extend({
	  ...
	  onConfirm: function onConfirm(event) {
	    var $address1 = this.$el.find('.address1');
	    ...
	    if (!this.$el.find('.error').length) {
	      ...
	      (0, _jquery2.default)('.button-bar').hide();
	    }
	  }
	});
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"panel panel-primary\">\n    <div class=\"panel-heading\">\n        <h3 class=\"panel-title\">{model:name}</h3>\n    </div>\n    <div class=\"panel-body form-horizontal\">\n\n      <div class=\"form-group\">\n          <img rv-src=\"model:image_path\" rv-alt=\"model:name\" height=\"150\" width=\"150\" />\n      </div>\n\n      <div class=\"form-group\">\n          <label class=\"col-sm-2 control-label\">Size</label>\n          <div class=\"col-sm-10\">\n            <span>{model:size}</span>\n          </div>\n      </div>\n\n      <div class=\"form-group\">\n        <label class=\"col-sm-2 control-label\">Color</label>\n        <div class=\"col-sm-10\">\n          <span>{model:color}</span>\n        </div>\n      </div>\n\n      <div class=\"form-group\">\n          <label class=\"col-sm-2 control-label\">Quantity</label>\n          <div class=\"col-sm-10\">\n            <span>{model:quantity}</span>\n          </div>\n      </div>\n\n      <div id=\"review-partials\">\n        <div class=\"shippingStrip\">Shipping to: </div>\n        <form role=\"form\" class=\"form-horizontal\">\n            <div class=\"form-group\">\n                <label class=\"col-sm-2 control-label\">Address1</label>\n                <div class=\"col-sm-10\">\n                    <input type=\"text\" placeholder=\"Street Address\" class=\"form-control address1\" rv-value=\"model:address1\">\n                </div>\n            </div>\n\n            <div class=\"form-group\">\n                <label class=\"col-sm-2 control-label\">Address2</label>\n                <div class=\"col-sm-10\">\n                    <input type=\"text\" placeholder=\"Apartment/Unit\" class=\"form-control address2\" rv-value=\"model:address2\">\n                </div>\n            </div>\n\n            <div class=\"form-group\">\n                <label class=\"col-sm-2 control-label\">City</label>\n                <div class=\"col-sm-10\">\n                    <input type=\"text\" placeholder=\"City\" class=\"form-control city\" rv-value=\"model:city\" size=\"20\">\n                </div>\n            </div>\n\n            <div class=\"form-group\">\n                <label class=\"col-sm-2 control-label\">State</label>\n                <div class=\"col-sm-10\">\n                    <input type=\"text\" placeholder=\"State\" class=\"form-control state\" rv-value=\"model:state\" size=\"5\">\n                </div>\n            </div>\n\n            <div class=\"form-group\">\n                <label class=\"col-sm-2 control-label\">Zip Code</label>\n                <div class=\"col-sm-10\">\n                    <input type=\"text\" placeholder=\"Zipcode\" class=\"form-control zip\" rv-value=\"model:zip\" size=\"10\">\n                </div>\n            </div>\n\n        </form>\n      </div>\n\n    </div>\n</div>\n\n<div class=\"button-bar\">\n    <button id=\"confirm\" class=\"btn btn-success\">Confirm</button>\n</div>\n";
